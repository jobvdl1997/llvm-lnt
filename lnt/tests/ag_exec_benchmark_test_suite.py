...
class TestSuiteTest(BuiltinTest):
    ...
    def run_test(self, opts):
        ...
        return self.submit(report_path, opts, 'ag')
    ...
    def _parse_lit_output(self, path, data, cmake_vars, only_test=False):
        LIT_METRIC_CONV_FN = {
            ...
            'parsing_file': float,
            'loading_graph': float,
            'creating_resultSet': float,
            'printing_query': float,
            'printing_results': float,
            'collecting_instrumentation': float,
            'collecting_memory_statistics': float,
            'mapped_graph_cur': float,
            'mapped_graph_max': float,
            'mapped_string_pool_cur': float,
            'mapped_string_pool_max': float,
            'edges_cur': float,
            'edges_max': float,
            'vertices_cur': float,
            'vertices_max': float,
            'properties_cur': float,
            'properties_max': float,
            'indexes_cur': float,
            'indexes_max': float,
        }
        LIT_METRIC_TO_LNT = {
            ...
            'creating_resultSet': 'creating_resultSet',
            'printing_query': 'printing_query',
            'printing_results': 'printing_results',
            'collecting_instrumentation': 'collecting_instrumentation',
            'collecting_memory_statistics': 'collecting_memory_statistics',
            'mapped_graph_cur': 'mapped_graph_cur',
            'mapped_graph_max': 'mapped_graph_max',
            'mapped_string_pool_cur': 'mapped_string_pool_cur',
            'mapped_string_pool_max': 'mapped_string_pool_max',
            'edges_cur': 'edges_cur',
            'edges_max': 'edges_max',
            'vertices_cur': 'vertices_cur',
            'vertices_max': 'vertices_max',
            'properties_cur': 'properties_cur',
            'properties_max':  'properties_max',
            'indexes_cur': 'indexes_cur',
        ...
        if self.opts.run_order:
            ...
            run_info['run_order'] = int(datetime.datetime.now().timestamp())
